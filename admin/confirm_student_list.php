        ...
        <div id="panel" class="" style="margin:0 auto; width:90%;">
          ...
          <div id="tabs">
            <ul class="nav nav-tabs " role="tablist" style="border-bottom:1;">
              ...
              <li><a href="#registration" role="tab" data-toggle="tab"><i class="icon icon-book"></i> Student Registration</a></li>
            </ul>
            <!-- Tab panes -->
            <div class="tab-content" style="height:90%;height: 89%;overflow-y: auto;">
              <div class="tab-pane active" id="student">
                ...
                <table id="student_list_table" class="table table-striped table-bordered" cellspacing="0" width="100%" style="table-layout:fixed">
                    ...
                    <?php
                        ...
                        $query_student = mysql_query("SELECT * FROM student_t ") or die("Error at $query_student::confirm_student_list.php:: ".mysql_error());
              ...
              <div class="tab-pane" id="registration">
                ...
                <table id="student_reg_table" class="table table-striped table-bordered" cellspacing="0" width="100%" style="table-layout:fixed">
                    <thead>
                        <tr>
                    ...
                    <?php
                        ...
                        $query_reg = mysql_query("SELECT * FROM student_registration_t ") or die("Error at $query_reg::confirm_student_list.php:: ".mysql_error());
                    ...
                    <tbody>
                    <?php while($row_reg = mysql_fetch_assoc($query_reg)){ ?>
                        <tr>
                            <td><?php echo $row_reg['reg_no']?></td>
                            <td><?php echo $row_reg['student_id']?></td>
                            <td><?php echo $row_reg['year_level']?></td>
                            <td><?php echo $row_reg['course_code']?></td>
                            <td>
                                <a href="#" onclick="account_delete(<?php echo $row_student['student_id']?>)" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-trash"></span></a>
                            </td>

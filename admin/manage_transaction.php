...
$query=mysql_query("SELECT * FROM unit_t WHERE unit_id='$unit_id'") or die(mysql_error());
...
if(($unit_type=='course') || ($unit_type=='department')){
    //echo "here";
    header("location: manage_transaction_nt.php?unit_id=$unit_id");
}
  ...
  <section style="padding-bottom:0; padding-top:20px; height:90%">
        <div id="panel" style="width: 79%;
            ...
            <a class="btn btn-info" href="position_list.php?unit_id=<?php echo $unit_id; ?>" style="position:absolute; margin-top: -30px; margin-left: 890px;"><i class="icon-list"></i> Positions</a>
                ...
                <div class="col-md-6" style="height:300px; padding: 0px 10px 0px 0px;">
                ...
                $count_s=0;
					...
					<form method="POST" action="actions/manage_position.php" style="padding: 0px; box-shadow: none">
						  ...
						  <li class="list-group-item"><strong id="officer<?php echo $count_p ?>"><?php echo $full_name  ?></strong><br />
                          <p style="margin-bottom: 0px; font-size: 12px;"><?php echo $position_name ?></p>
                          <a class="btn btn-default btn-xs" id="edit<?php echo $count_p ?>" onclick="edit_officer('<?php echo $personnel_id ?>','<?php echo $count_p ?>')"><i class="icon-pencil"></i> Edit</a>
                          <input type="submit" name="ok_edit" class="btn btn-success btn-xs hidden" id="ok<?php echo $count_p ?>" value="OK" />
                          <a class="btn btn-danger btn-xs" href="actions/manage_position.php?action=delete_officer&&pm_id=<?php echo $pm_id ?>" onclick="return confirm('Are you sure you want to delete this officer?')"><i class="icon-trash"></i> Delete</a>
                          </li>
                    </form>
        ...
        <div class="modal-content " style="height: 85%; width: 92%;">  <!--modified-->
         ...
         <form class="center" style="padding: 0px; padding: 0px; box-shadow: none" role="form" action="actions/manage_position.php" method="post" id="addpost_event" name="addpost_event" enctype="multipart/form-data" >
          ...
          <button type="button" class="btn btn-danger" data-dismiss="modal"> CLOSE</button>
                 ...
                 <div class="col-md-6" style="height:300px; padding:0px;">
                    <div class="panel panel-default" style="width:100%">
                      <div class="panel-heading" style="line-height: 33px;">Transactions
                      
                      <div style="float:right">
                      <a class="btn btn-default" data-toggle="modal" href="#add_trans"><i class="icon-plus"></i> Add</a>
                      </div>
           ...
           <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%" style="table-layout:fixed; width:490px;">
                      ...
                      <colgroup>
                        ...
                        <?php
                          ...
                          <tr>
                            ...
                            <td>
                            <a class="btn btn-default btn-xs" href="manage_procedure.php?trans_id=<?php echo $trans_id ?>"><i class="icon-eye-open"></i> View Procedures</a>
                            <a style="width: 55px;" class="btn btn-info btn-xs" data-toggle="modal" href="#edit_trans<?php echo $trans_id ?>"><i class="icon-edit"></i> Edit</a>
							<a class="btn btn-danger btn-xs" href="actions/addEdit_trans_action.php?unit_id=<?php echo $unit_id; ?>&&service_id=<?php echo $trans_id ?>&&action=delete" onClick="return confirm('Are you sure you want to delete this transaction?')"><i class="icon-trash"></i> Delete</a>
                            </td>
						   
						</tr>
                        <div id="edit_trans<?php echo $trans_id ?>" class="modal fade " style=" overflow-y:hidden;" ><!--modified-->
                                ...
                                <div class="modal-content " style="height: 51%; width: 92%;">  <!--modified-->
                                    ...
                                    <div class="modal-" style="height: 100%; display: inline-block; padding: 20px;" > <!--modified-->
                                       <div class="modal-body" style="width: 420px;">
                                               ...
                                               <button type="button" class="close" data-dismiss="modal">&times;</button>
                                               <h4 id="post_title">Edit Service</h4>
                     						 	<hr>
                                               <form action="actions/addEdit_trans_action.php" method="post">
                                                    ...
                                                    <div class="form-group">
                                                       <textarea style="width: 100%; height: 100%;" name="trans_name"><?php echo $transaction_name; ?></textarea>
                                                    </div>

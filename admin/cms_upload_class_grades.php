...
<body style="padding-top: 0px;">
 				...
 				<div class="panel panel-default"style="padding:0px;">
 							...
 							<h3><span class="glyphicon glyphicon-upload"></span> Upload Grades</h3>
 							</div>
                            ...
                            <hr>
                            <form id="grades" onsubmit="return validate()" role="form" action="excel_upload/upload_grades.php" method="post" style="width:50%;margin:0 auto;" enctype="multipart/form-data">
                              ...
                              <div class="form-group">
                                ...
                                <div style="text-align:center;margin:20px;">
                                    <a href="excel_upload/download_student_grades_template.php" class="btn btn-default btn-xs"><span class="glyphicon icon-download"></span> Download Template</a>
                                </div>
                            </form>

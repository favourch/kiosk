...
foreach ($posts as $key=>$value) {
    ...
    //echo $post_id;
		...
		$select_post_hol=mysql_query("SELECT * FROM post_holidays_t WHERE holiday_id='$post_id'");
			  while($row_post_hol=mysql_fetch_assoc($select_post_hol)) {
                        $date_of_holiday=$row_post_hol['date_of_holiday'];
			  			//echo "dito";
						$holidate=strtotime($date_of_holiday);
         ...
         <div class="post_h">
		    ...
		    ?>
                ...
                <div class="content">
                	...
                	<div id="title"><?php echo date("F j, Y", $holidate); ?></div>
                    <hr style="" /> 
                   
                    <p style="font-size:25px"><strong><?php echo strtoupper($post_title); ?></strong></p>
